$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '937f53d0116f87b0bf987a13827c0f8e';
    var title = $('.movie').val();
    if (title=="") {
      ...
      //invoke function call updated 
      //thread processing needs parallel 3 threads
      //3 logical 1 physical thread needed 
    }
  });
});
